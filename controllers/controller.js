...
const controller = {
    ...
    postUpload: function (req, res, next) {
        ...
        const inf = require('child_process').exec('python Real-ESRGAN/inference_realesrgan.py -i public/uploads/' + req.file.filename + ' -s 3.5 -o public/output/ --ext png --fp32 --tile 50')
